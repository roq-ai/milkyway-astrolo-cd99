...
import { getBirthchartAnalysisById } from 'apiSdk/birthchart-analyses';
import { BirthchartAnalysisInterface } from 'interfaces/birthchart-analysis';

function BirthchartAnalysisViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Birthchart Analysis Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Birthchart Analysis Details
                  </Text>
                </Box>
                {hasAccess('birthchart_analysis', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/birthchart-analyses/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Planetary Positions" text={data?.planetary_positions} />

                <FormListItem label="Dominant Planet" text={data?.dominant_planet} />

                <FormListItem label="Analysis Summary" text={data?.analysis_summary} />

                <FormListItem label="Life Path Number" text={data?.life_path_number} />
              </List>
            </FormWrapper>
          </>
        )}
