...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Milkyway Astrology v1`}</title>

        <meta
          name="description"
          content="Welcome to Milkyway Astrology v1, your personal gateway to Vedic Astrology. Discover your free birthchart, schedule readings, and engage with AI chat about astrology."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Milkyway Astrology v1`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Milkyway Astrology v1, your personal gateway to Vedic Astrology. Discover your free birthchart, schedule readings, and engage with AI chat about astrology.`}
            </Text>
            <Box
