...
import { getBirthchartById } from 'apiSdk/birthcharts';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('birthchart', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/birthcharts/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Sun Sign" text={data?.sun_sign} />

                <FormListItem label="Moon Sign" text={data?.moon_sign} />

                <FormListItem label="Rising Sign" text={data?.rising_sign} />
