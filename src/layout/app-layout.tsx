...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Birthchart Analyses',
      path: '/birthchart-analyses',
      entity: 'birthchart_analysis',
      service: AccessServiceEnum.PROJECT,
      icon: FiPieChart,
    },
    {
      name: 'Birthchart Interpretations',
      path: '/birthchart-interpretations',
      entity: 'birthchart_interpretation',
      service: AccessServiceEnum.PROJECT,
      icon: FiCompass,
    },
    { name: 'Chats', path: '/chats', entity: 'chat', service: AccessServiceEnum.PROJECT, icon: FiMessageCircle },
    { name: 'Readings', path: '/readings', entity: 'reading', service: AccessServiceEnum.PROJECT, icon: FiClock },
    {
