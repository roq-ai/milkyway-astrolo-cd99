...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'booking.create': { roles: ['tenant-owner', 'astrologer'], key: 'bookingId', tenantPath: [], userPath: [] },
  'session.update': { roles: ['tenant-owner', 'astrologer'], key: 'sessionId', tenantPath: [], userPath: [] },
  'session.delete': { roles: ['tenant-owner', 'customer'], key: 'sessionId', tenantPath: [], userPath: [] },
};
